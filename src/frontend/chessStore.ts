...
import { ChessActiveGameInfo, ChessChallenge, ChessChallengeUpdate, ChessDrawDeclinedUpdate, ChessDrawOfferUpdate, ChessGameID, ChessGameInfo, ChessPositionUpdate, ChessResultUpdate, ChessUpdate, Ship } from './ts/types'
